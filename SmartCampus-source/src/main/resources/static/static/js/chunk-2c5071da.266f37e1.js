(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["chunk-2c5071da"], {
    2017: function (e, t, o) {
        ...
        var s = function () {
            ...
            return o("div", {staticClass: "login-container"}, [o("el-form", {
            ...
            }, [o("div", {staticClass: "title-container"}, [o("h3", {staticClass: "title"}, [e._v("Smart Campus Management System")])]), o("el-form-item", {attrs: {prop: "username"}}, [o("span", {staticClass: "svg-container"}, [o("svg-icon", {attrs: {"icon-class": "user"}})], 1), o("el-input", {
                ref: "username",
                ...
                ref: "verifiCode",
                attrs: {placeholder: "Verification Code", name: "verifiCode"},
                model: {
                ...
                attrs: {
                    title: "Click to switch the verification code",
                    src: e.codeImgUrl,
                    alt: "#"
                }
            })])], 1), o("el-form-item", {
            ...
            }, [o("el-radio", {attrs: {label: 1}}, [e._v("Administrator")]), o("el-radio", {attrs: {label: 2}}, [e._v("Student")]), o("el-radio", {attrs: {label: 3}}, [e._v("Teacher")])], 1)], 1), o("el-button", {
                staticStyle: {
                    width: "100%",
                    "margin-bottom": "30px"
            ...
            name: "Login", data: function () {
                var e = function (e, t, o) {
                    t.length < 2 ? o(new Error("The username length cannot be less than 2 characters.")) : o()
                }, t = function (e, t, o) {
                    t.length < 5 ? o(new Error("The password length cannot be less than 5 characters.")) : o()
                };
                return {
                    ...
                    loginRules: {
                        ...
                        verifiCode: [{required: !0, message: "Verification code is required."}],
                        userType: [{required: !0, message: "Usertype selection is required."}]
                    },
                    loading: !1,
