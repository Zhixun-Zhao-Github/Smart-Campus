    ...
    2953: function (e, t, a) {
        ...
        var r = function () {
            ...
            return a("el-card", {staticClass: "grade"}, [a("div", [a("el-form", {
                ...
                slot: "reference"
            }, [e._v("Batch delete")])], 1)], 1), a("el-form-item", {attrs: {label: "Administrator's name:"}}, [a("el-input", {
                attrs: {
                    placeholder: "Please enter the administrator's name.",
                    size: "small"
                }, model: {
                ...
                attrs: {
                    title: e.form.id ? "Modify administrator information" : "Add administrator information",
            ...
            name: "AdminManage", data: function () {
                return {
                    ...
                    rules: {
                        ...
                        password: [{required: !0, message: "Password is required"}, {min: 6, message: "Password must be at least 6 characters"}],
                        password2: [{required: !0, message: "Confirmation password is required"}, {validator: this.validatePwd2}],
