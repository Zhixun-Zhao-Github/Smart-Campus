    ...
    "06f1": function (e, t, n) {
        ...
        t.__esModule = !0, t.default = {
            el: {
                ...
                cascader: {noMatch: "No matching data", loading: "Loading", placeholder: "Please select", noData: "No data"},
                pagination: {goto: "Go to", pagesize: "items/page", total: "Total {total} items", pageClassifier: "Page"},
                messagebox: {title: "Notice", confirm: "Confirm", cancel: "Cancel", error: "Invalid input!"},
                upload: {deleteTip: "Press delete key to remove", delete: "Delete", preview: "Preview", continue: "Continue uploading"},
                table: {
                    emptyText: "No data",
                ...
                popconfirm: {confirmButtonText: "Confirm", cancelButtonText: "Cancel"}
            }            
        }
    }, f225: function (e, t, n) {
    }, f3ad: function (e, t, n) {
